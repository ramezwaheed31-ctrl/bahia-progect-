...
medical_data = [
    {"title": "Breast Cancer Symptoms", "content": "Lumps, skin dimpling, and nipple discharge are common symptoms."},
    {"title": "Diagnosis Methods", "content": "Mammograms, ultrasounds, and biopsies are used for diagnosis."},
    {"title": "Treatment Options", "content": "Surgery, chemotherapy, and radiation therapy are standard treatments."}
]
